...
- 样本用途类别：`{"existence_recovered_by_temporal_continuation": 8, "temporal_continuation_with_detection_dropout": 12, "secondary_supported_truncated_same_vehicle": 8, "yolo_upgrade_candidate": 12, "manual_review_required": 12, "exclude_from_clean_shape_statistics": 12, "sar_posthoc_supported_dropout_case": 12}`。
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| GM_RM017 | 97 | 149 | 310 | true | 6 | 10 | temporal_continuation_with_current_secondary_support | temporal_propagation_can_recover_review_target | existence_recovered_by_temporal_continuation;temporal_continuation_with_detection_dropout;secondary_supported_truncated_same_vehicle;yolo_upgrade_candidate;manual_review_required;exclude_from_clean_shape_statistics;sar_posthoc_supported_dropout_case |
...
| GM_RM017 | 308 | 214 | 446 | true | 10 | 0 | temporal_continuation_with_detection_dropout | temporal_propagation_can_recover_review_target | existence_recovered_by_temporal_continuation;temporal_continuation_with_detection_dropout;secondary_supported_truncated_same_vehicle;yolo_upgrade_candidate;manual_review_required;exclude_from_clean_shape_statistics;sar_posthoc_supported_dropout_case |
...
| GM_RM019 | 322 | 97 | 202 | true | 0 | 10 | temporal_continuation_with_detection_dropout | temporal_propagation_can_recover_review_target | existence_recovered_by_temporal_continuation;temporal_continuation_with_detection_dropout;secondary_supported_truncated_same_vehicle;yolo_upgrade_candidate;manual_review_required;exclude_from_clean_shape_statistics;sar_posthoc_supported_dropout_case |
